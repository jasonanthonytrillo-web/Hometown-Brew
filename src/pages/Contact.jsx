        ...
        <div className="contact-container">
          ...
          <div className="contact-form-wrapper">
            ...
            <div className="google-rating-wrapper">
              ...
              <a 
                href="https://www.google.com/search?q=google+review+homebtown+brew&oq=google+review+homebtown+brew&gs_lcrp=EgZjaHJvbWUyCQgAEEUYORigATIGCAEQRRhA0gEINTY3MmowajeoAgCwAgA&sourceid=chrome&ie=UTF-8&lqi=Chtnb29nbGUgcmV2aWV3IGhvbWV0b3duIGJyZXciBTgBiAEBSN7b9r75vYCACFoXEAAQARgAGAEiDWhvbWV0b3duIGJyZXeSAQtjb2ZmZWVfc2hvcA#rlimm=7031854727181185230&lrd=0x3301c700508e70c9:0x61962a9e35c930ce,3,,,,"
                target="_blank" 
          ...
          <div className="contact-info-wrapper">
            ...
            <div className="contact-info-items">
              ...
              <div className="contact-info-item">
                ...
                <div className="info-text">
                  <h3>Email</h3>
                  <p>hometownbrew@prototype.com</p>
                </div>
              </div>
